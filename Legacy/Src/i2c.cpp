...
I2cStatus I2cBus::write(std::uint8_t address, const std::uint8_t* data, std::size_t size)
{
...
I2cStatus I2cBus::read(std::uint8_t address, std::uint8_t* data, std::size_t size)
{
    if ((!initialized_) || (data == nullptr) || (size == 0U)) {
        return I2cStatus::InvalidArgument;
    }
...
I2cStatus I2cBus::writeRead(std::uint8_t address,
